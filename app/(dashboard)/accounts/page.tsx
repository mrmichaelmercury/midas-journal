...
function AccountCard({
  ...
  return (
    <div className="glass rounded-2xl p-5 hover:border-gray-300 transition-all">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold text-gray-900">{account.nickname || name}</div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        <div className="bg-gray-50 rounded-xl p-3">
          ...
          <div className="text-lg font-bold text-gray-900">{account.tradeCount}</div>
        </div>
        <div className="bg-gray-50 rounded-xl p-3">
      ...
      <div className="flex gap-2 mt-4">
        <button
          ...
          className="flex items-center gap-2 flex-1 justify-center px-3 py-2 rounded-xl bg-amber-50 border border-amber-200 text-amber-600 text-sm font-medium hover:bg-amber-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-xl bg-red-50 border border-red-200 text-red-600 text-sm font-medium hover:bg-red-100 transition-all"
        >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            {view === 'picker' ? (
              <h2 className="font-bold text-gray-900">Connect Account</h2>
            ) : (
              <div className="flex items-center gap-2">
                <button onClick={() => setView('picker')} className="text-gray-400 hover:text-gray-700 transition-colors">
                  <ChevronRight className="w-4 h-4 rotate-180" />
                </button>
                <h2 className="font-bold text-gray-900">Connect Tradovate</h2>
              </div>
            )}
          ...
          {view === 'picker' && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center gap-4 p-4 rounded-xl border border-gray-200 hover:border-amber-300 hover:bg-amber-50 transition-all text-left group"
              >
                <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-xl flex-shrink-0">
                  🔷
                </div>
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-gray-900">Tradovate</div>
                  <div className="text-xs text-gray-500 mt-0.5">Covers Apex Trader Funding & Tradeify</div>
                  <div className="text-xs text-emerald-600 mt-1">API access is free and public</div>
                </div>
                <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-amber-500 transition-colors flex-shrink-0" />
              </button>

              {/* Rithmic */}
              <div className="w-full flex items-center gap-4 p-4 rounded-xl border border-gray-100 opacity-50 cursor-not-allowed">
                <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-xl flex-shrink-0">
                  🔶
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-gray-900">Rithmic</span>
              ...
              <div className="w-full flex items-center gap-4 p-4 rounded-xl border border-gray-100 opacity-50 cursor-not-allowed">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-gray-900">MetaTrader 4/5</span>
                    <span className="text-xs px-2 py-0.5 rounded-full bg-gray-100 text-gray-500 border border-gray-200">
                      Coming Soon
                    </span>
                  </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:border-amber-400 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 pr-10 text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:border-amber-400 transition-colors"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold py-2.5 rounded-xl hover:shadow-lg hover:shadow-amber-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2"
              >
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-black text-gray-900">Connected Accounts</h1>
          <p className="text-gray-500 mt-1">Manage your broker connections and sync trade data</p>
        </div>
        <button
          onClick={() => setShowModal(true)}
          className="flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold px-5 py-2.5 rounded-xl hover:shadow-lg hover:shadow-amber-500/30 transition-all"
        >
      ...
      {loading ? (
        ...
        <div className="glass rounded-2xl p-12 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">No accounts connected yet</h3>
